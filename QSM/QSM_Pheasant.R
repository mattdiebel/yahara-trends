...
INFO = readNWISInfo("05427948", "00665", interactive=FALSE)
INFO$shortName = "Pheasant Branch"
INFO$staAbbrev = "PBM"
INFO$paramShortName = "Total Phosphorus"
INFO$constitAbbrev = "TP"
Sample = readUserSample("C:/LWRD/yahara-trends/QSM/", "PB_sample.csv", separator=",")
Daily = readNWISDaily("05427948", "00060", "1991-10-01", "2018-09-30")
...
R2 = round(summary(lm)$r.squared,2)
plot_title = paste0("Pheasant Branch QSM", "\nR-squared = ", R2, ", RMSE = ", RMSE)
lims = c(min(Sample$ConcHat_QSM,Sample$ConcAve),max(Sample$ConcHat_QSM,Sample$ConcAve))
png("PB_QSM_fit_obs.png", res=300, height=1800, width=1800)
...
png("PB_FNConc_annual_trend.png", res=300, height=1800, width=1800)
plot(FNConc~WY, WY, type="l", xlab="", main="Pheasant Branch")
lines(FNConc_QSM~waterYear, WY_QSM_conc, lty=2)
legend("topright", lty=c(1,2), legend=c("WRTDS","QSM"), bty="n")
dev.off()

png("PB_FNFlux_annual_trend.png", res=300, height=1800, width=1800)
plot(FNFlux~WY, WY, type="l", xlab="", main="Pheasant Branch")
